...
COSMCtrlException::COSMCtrlException()
{
                       ...
                       m_bGPSFix(FALSE)
{
 ...
 COSMCtrl::~COSMCtrl()
 {
  ...
  void   COSMCtrl:: AddMarker(COSMCtrlMarker& marker)
  {
	  m_Markers.Add(new COSMCtrlMarker(marker));
  }
  COSMCtrlMarker& COSMCtrl::GetMarker(int index)
  {
	  if(this->m_Markers.GetSize()<=index||index<0)
		  throw COSMCtrlException();
	  return *m_Markers[index];
  }
  int   COSMCtrl:: GetMarkerCount()
  {
	  return m_Markers.GetSize();
  }
  void   COSMCtrl:: RemoveMarker(COSMCtrlMarker* marker)
  {
	  if(marker==NULL)
		  return;
  ...
  void  COSMCtrl:: AddPolyline(COSMCtrlPolyline& polyline)
  {
	  m_Polylines.Add(new COSMCtrlPolyline(polyline));
  }
  COSMCtrlPolyline& COSMCtrl::GetPolyline(int index)
  {
	  if(this->m_Polylines.GetSize()<=index||index<0)
		  throw COSMCtrlException();
	  return *m_Polylines[index];
  }
  int  COSMCtrl::GetPolylineCount()
  {
	  return m_Polylines.GetSize();
  }
  void  COSMCtrl::RemovePolyline(COSMCtrlPolyline* polyline)
  {
	  if(polyline==NULL)
		  return;
	  for(int i=0;i < m_Polylines.GetSize();i++)
	  {
		  if(m_Polylines[i] == polyline)
		  {
  ...
  void   COSMCtrl:: RemoveAllPolylines()
  {
	  for(int i=0;i < m_Polylines.GetSize();i++)
	  {
...
void COSMCtrl::HandleLButtonDownPolylineCreation(UINT /*nFlags*/, CPoint point, MapItem /*item*/, INT_PTR /*nItem*/, INT_PTR /*nSubItem*/)
{
  ...
  {
    COSMCtrlPolyline *newPolyline = new COSMCtrlPolyline;
...
void COSMCtrl::HandleLButtonDownPolygonCreation(UINT /*nFlags*/, CPoint point, MapItem /*item*/, INT_PTR /*nItem*/, INT_PTR /*nSubItem*/)
{
  ...
  if (ClientToPosition(tempPoint, rClient, newPosition))
  {
    COSMCtrlPolygon* newPolygon = new COSMCtrlPolygon;
    COSMCtrlNode node(newPosition.m_fLongitude, newPosition.m_fLatitude);
...
void COSMCtrl::HandleLButtonDownMarkerCreation(UINT /*nFlags*/, CPoint point, MapItem /*item*/, INT_PTR /*nItem*/, INT_PTR /*nSubItem*/)
{
  ...
  if (ClientToPosition(tempPoint, rClient, newPosition))
  {
    COSMCtrlMarker *newMarker = new COSMCtrlMarker;
...
void COSMCtrl::HandleLButtonDownCircleCreation(UINT /*nFlags*/, CPoint point, MapItem /*item*/, INT_PTR /*nItem*/, INT_PTR /*nSubItem*/)
{
  ...
  if (ClientToPosition(tempPoint, rClient, newPosition))
  {
    COSMCtrlCircle* newCircle = new COSMCtrlCircle;
...
{
	  //let the base class do its thing
 //  CStatic::OnMouseWheel(nFlags, zDelta, pt);
