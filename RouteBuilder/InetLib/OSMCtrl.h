...
class  INETLIB_API COSMCtrlException 
{
 public:
	 COSMCtrlException();
	 ~COSMCtrlException();
...
class AFX_EXT_CLASS  COSMCtrl : public CStatic
{
public:
//Enums
  enum DownloadOrder
...
// Objects Management
  void            AddMarker(COSMCtrlMarker& marker);
  COSMCtrlMarker& GetMarker(int index);
  int             GetMarkerCount();
  void            RemoveMarker(COSMCtrlMarker* marker);
  void            RemoveAllMarkes();

  void              AddPolyline(COSMCtrlPolyline& polyline);
  COSMCtrlPolyline& GetPolyline(int index);
  int               GetPolylineCount();
  void              RemovePolyline(COSMCtrlPolyline* polyline);
