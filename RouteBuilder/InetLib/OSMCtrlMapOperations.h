...
class AFX_EXT_CLASS COSMCtrlMapOperationsDlgEvent
{
public:
...
class  AFX_EXT_CLASS COSMCtrlMapOperationsDlgTile
{
public:
//Constructors / Destructors
...
class AFX_EXT_CLASS COSMCtrlMapOperationsDlg : public CDialog
{
public:
//Constructors / Destructors
...
//Member variables
  ...
  CArray<COSMCtrlMapOperationsDlgEvent, COSMCtrlMapOperationsDlgEvent&> m_PendingEvents;        //The pending events coming from the worker thread
  CCriticalSection                                                      m_csPendingEvents;      //critical section used to serialize access to "m_PendingEvents"
  CArray<COSMCtrlMapOperationsDlgTile, COSMCtrlMapOperationsDlgTile&>   m_Tiles;                //The tiles we will be working on
