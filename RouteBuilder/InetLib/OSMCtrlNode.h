...
//Constructors / Destructors
  ...
  COSMCtrlNode(double fLongitude, double fLatitude, double fBearing = 0, double fSpeed = 0, BOOL bSelected = FALSE, BOOL bBearingValid = FALSE, BOOL bSpeedValid = FALSE) : m_Position(fLongitude, fLatitude, fBearing, fSpeed, bBearingValid, bSpeedValid)
  {
  }
