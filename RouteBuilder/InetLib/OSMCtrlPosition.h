...
class AFX_EXT_CLASS COSMCtrlPosition
{
public:
//Constructors / Destructors
  COSMCtrlPosition();
  COSMCtrlPosition(double fLongitude, double fLatitude, double fBearing = 0, double fSpeed = 0, BOOL bBearingValid = FALSE, BOOL bSpeedValid = FALSE);
