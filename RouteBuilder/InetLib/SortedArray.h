...
Copyright (c) 1999 - 2010 by PJ Naughter (Web: www.naughter.com, Email: pjna@naughter.com)
...
//Methods
  ...
  INT_PTR OrderedInsert(ARG_TYPE newElement, INT_PTR nCount = 1)
  {
    ...
    TYPE* pData = GetData();
	  ...
	  {
      ATLASSUME(pData); //Note we do not do the ASSERT outside of the loop because
